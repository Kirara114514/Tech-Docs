...
## 摘要
 在上一篇中，我们详细探讨了 UniRx 的核心组件 **`ReactiveProperty<T>`**，了解了它如何让数据变化自动通知订阅者，从而简化了数据绑定和状态管理。`ReactiveProperty<T>` 能够告诉我们“值变了，新值是什么”，这在很多场景下都非常有用。 然而，在实际的游戏开发中，我们经常会遇到这样的需求：**不仅想知道“值变了”，还想知道“值是从什么变成了什么”*...
