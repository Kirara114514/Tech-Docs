...
## 摘要
 Unity 引擎内置了一套强大且易用的物理系统，它基于 NVIDIA 的 PhysX 物理引擎。这个系统能让你在游戏中模拟真实的物理效果，比如重力、碰撞、摩擦、弹跳等，极大地提升游戏的沉浸感和交互性。本篇教程将带你了解 Unity 物理系统的核心组件和常用 API，让你能够快速地在项目中应用物理效果。 ---------- ### 1. Rigidbody（刚体）组件：赋予物体物理属性 在...
